...
MySQL - 8.0.33 : Database - concessionaria
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`concessionaria` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
('DER-2020','Hyundai','HB20',2021,98000),
('FAX-2235','Hyundai','HB20',2021,71000),
('FEW-4321','Chevrolet','Onix',2020,85000),
...
('MRT-1111','Fiat','Pulse',2023,147000),
('XEN-2223','VW','Passat',2023,177500),
('ZEN-3231','Renault','Clio',2020,45000);
